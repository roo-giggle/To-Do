  ...
  return (
    <div className="App">
      <div className="container">
        ...
        <form className="todo">
          <input type="text" className="control" onChange={(e) => setInput(e.target.value)} placeholder="Enter Your Text" name="text"/>
        ...
        <div className="todos_wrapper">
         ...
         <div className="todos_list">
           ...
           {completed.map((items,i) => 
            <div className="completed_card" key={items.id}>
              <p className="card_text">{items.text}</p>
            </div>
           )}
         </div>
        </div>
